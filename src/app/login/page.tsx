...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex-1 flex flex-col p-6 items-center justify-center py-12">
      ...
      <div className="p-6 text-center bg-background shrink-0 pb-[calc(1.5rem+env(safe-area-inset-bottom))]">
