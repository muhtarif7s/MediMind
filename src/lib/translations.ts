...
export const translations = {
  ar: {
    ...
    phone: 'رقم الهاتف',
    notes: 'ملاحظات طبية',
    noNotes: 'لا توجد ملاحظات طبية مضافة',
    save: 'حفظ',
    cancel: 'إلغاء',
    ...
    authError: 'بيانات الاعتماد غير صالحة. يرجى المحاولة مرة أخرى.',
    settings: 'الإعدادات',
    ...
    recordTitle: 'عنوان السجل (مثلاً: أشعة سينية فك علوي)',
  ...
  en: {
    ...
    operationNotAllowed: 'This sign-in method is currently disabled. Please contact support.',
    seconds: 's',
    medicalRecords: 'Medical Records',
    addRecord: 'Add Record',
    recordTitle: 'Record Title (e.g. Upper Jaw X-Ray)',
  ...
  fr: {
    ...
    noNotes: 'Aucune note médicale ajoutée',
    save: 'Enregistrer',
    cancel: 'Annuler',
    ...
    authError: 'Identifiants invalides. Veuillez réessayer.',
    settings: 'Paramètres',
    ...
    monthlyGrowth: 'Croissance et Activité',
    ...
    lowStockWarning: 'Stock faible ! Recharge recommandée.',
    refill: 'Recharger',
    dosage: 'Dosage',
    frequency: 'Fréquence',
    ...
    trackProgress: 'Suivez votre progression et votre cohérence.',
    ...
    operationNotAllowed: 'Cette méthode de connexion est actuellement désactivée. Veuillez contacter le support.',
    seconds: 's',
    medicalRecords: 'Dossiers Médicaux',
    addRecord: 'Ajouter un dossier',
    recordTitle: 'Titre du dossier (ex: Radio Mâchoire)',
  ...
  es: {
    ...
    phone: 'Teléfono',
    notes: 'Notas Médicas',
    noNotes: 'Sin notas médicas añadidas',
    save: 'Guardar',
    cancel: 'Cancelar',
    ...
    authError: 'Credenciales inválidas. Por favor intente de nuevo.',
    settings: 'Ajustes',
    ...
    monthlyGrowth: 'Crecimiento y Actividad',
    ...
    lowStockWarning: '¡Stock bajo! Se recomienda rellenar.',
    refill: 'Rellenar',
    dosage: 'Dosis',
    ...
    trackProgress: 'Sigue tu progreso y consistencia.',
    ...
    operationNotAllowed: 'Este método de inicio de sesión está desactivado actualmente. Póngase en contacto con el soporte.',
    seconds: 's',
    medicalRecords: 'Registros Médicos',
    addRecord: 'Añadir registro',
    recordTitle: 'Título del registro (ej: Radiografía)',
  ...
  de: {
    ...
    noNotes: 'Keine medizinischen Notizen hinzugefügt',
    save: 'Speichern',
    cancel: 'Abbrechen',
    ...
    authError: 'Ungültige Anmeldedaten. Bitte versuchen Sie es erneut.',
    ...
    monthlyGrowth: 'Wachstum und Aktivität',
    ...
    lowStockWarning: 'Niedriger Bestand! Auffüllen empfohlen.',
    refill: 'Auffüllen',
    dosage: 'Dosierung',
    ...
    trackProgress: 'Verfolgen Sie Ihren Fortschritt und Ihre Beständigkeit.',
    ...
    operationNotAllowed: 'Diese Anmeldemethode ist derzeit deaktiviert. Bitte kontaktieren Sie den Support.',
    seconds: 's',
    medicalRecords: 'Medizinische Unterlagen',
    addRecord: 'Unterlage hinzufügen',
    recordTitle: 'Titel (z. B. Röntgenaufnahme)',
    recordType: 'Typ',
    xRay: 'Röntgenaufnahme',
    prescription: 'Rezept',
    report: 'Medizinischer Bericht',
    other: 'Sonstiges',
